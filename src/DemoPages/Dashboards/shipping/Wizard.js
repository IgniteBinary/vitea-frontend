...
export default class MultiStep extends React.Component {
                 ...
                 componentDidMount() {
                   console.log(this.props.shippingDetails.state, 'check here');
                   if (this.props.shippingDetails.state === 'DELIVERED') {
                     this.setState({
                       compState: 2,
                       navState: getNavStates(2, this.props.steps.length),
                     });
                   }
                   if (this.props.shippingDetails.state === 'SCHEDULED') {
                     this.setState({
                       compState: 0,
                       navState: getNavStates(0, this.props.steps.length),
                 });
                   ...
                   if (this.props.shippingDetails.state === 'ACTIVE') {
                     this.setState({
                       compState: 1,
                       navState: getNavStates(1, this.props.steps.length),
                     });
                   }
                   if (this.props.shippingDetails.state === 'CANCLED') {
                     this.setState({
                       compState: 3,
                       navState: getNavStates(3, this.props.steps.length),
                     });
                   }
                 }
                       ...
                       <div className='clearfix'>
                         ...
                         >
                           ...
                           <Button
                             ...
                             style={
                               this.state.showNextBtn ? {} : { display: 'none' }
                             }
                             onClick={this.next}
                           >
                             Next
